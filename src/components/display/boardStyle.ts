...
// зал видели бойцов на одних и тех же сторонах. Светлый двойник этой палитры —
// `lib/sideColors.ts` (пульт): распределение сторон общее, значения разные,
// потому что фон противоположный.

// Названия цветов на экране не подписаны: сторона читается по самому цвету и по
// позиции (слева/справа), а кто это — по имени и фамилии в той же панели.
